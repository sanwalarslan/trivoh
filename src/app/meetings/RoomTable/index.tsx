          ...
          <tbody className="rounded-lg">
            ...
            {meetings.map((meeting, index) => (
              ...
              >
                ...
                <td
                  className="h-12 py-6 font-medium text-sm whitespace-nowrap align-middle px-6 text-white"
                  style={{
                    animation: `slideInRight 0.5s ease-out forwards`,
                    animationDelay: `${index * 0.1}s`,
                  }}
                >
                  <div className="bg-[#007F74] cursor-pointer px-1 rounded-md justify-center items-center text-center py-2">
                    {meeting.role}
                  </div>
                </td>
                <td
                  ...
                  <div className="flex justify-between">
                    <button className="flex flex-row gap-x-2 px-4 bg-[#007F74] justify-center text-center rounded-md items-center py-2">
                      <div className="brightness-0 invert">
                        <Image src={video} className="text-white w-5 h-5" alt="video" />
                      </div>
                      <div className="font-medium text-sm text-white">Start</div>
                    </button>
